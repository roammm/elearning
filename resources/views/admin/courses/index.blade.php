...
<head>
    ...
    <style>
        ...
        .card-meta{display:flex;gap:16px;color:#6b7280;font-size:13px;margin-bottom:16px}
        .badge{display:inline-block;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:500}
        .badge-ppt{background:#e0f2fe;color:#0369a1}
        ...
        @media (max-width:640px){.container{padding:0 16px}.page-header{flex-direction:column;align-items:flex-start;gap:16px}.card-header{flex-direction:column;gap:12px}}
    </style>
</head>
<body>
    @include('navbar')
