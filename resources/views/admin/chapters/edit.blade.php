        ...
        <div class="card">
            <form action="{{ route('admin.chapters.update', $chapter) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-input" value="{{ old('title', $chapter->title) }}" required>
                    @error('title')<div class="error">{{ $message }}</div>@enderror
                </div>

                <div class="form-group">
                    <label class="form-label">Description</label>
                    <textarea name="description" class="form-textarea">{{ old('description', $chapter->description) }}</textarea>
                ...
                <div style="display:flex;gap:12px;margin-top:32px">
                    ...
                    <a href="{{ route('admin.chapters', $chapter->course) }}" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
