...
<head>
    ...
    <title>Create Chapter - Admin</title>
...
<body>
    ...
    <div class="container" style="padding-top:100px">
        <div class="page-header">
            <h1 class="page-title">Tambah Chapter - {{ $course->title }}</h1>
        </div>

        <div class="card">
            <form action="{{ route('admin.chapters.store', $course) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="type-select" class="form-input" required>
                        <option value="standard" {{ old('type') == 'standard' ? 'selected' : '' }}>Teks (Standard)</option>
                ...
                <div style="display:flex;gap:12px;margin-top:32px">
                    ...
                    <a href="{{ route('admin.chapters', $course) }}" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
