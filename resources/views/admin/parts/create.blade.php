...
<body>
    ...
    <div class="container" style="padding-top:100px">
        <div class="page-header">
            <h1 class="page-title">Tambah Part - {{ $chapter->title }}</h1>
        </div>

        <div class="card">
            <form action="{{ route('admin.parts.store', $chapter) }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" class="form-textarea" placeholder='["Paragraph 1", "Paragraph 2", ...]'>{{ old('content') }}</textarea>
                ...
                <div style="display:flex;gap:12px;margin-top:32px">
                    ...
                    <a href="{{ route('admin.parts', $chapter) }}" class="btn btn-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
