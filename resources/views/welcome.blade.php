    ...
    <header class="fixed w-full bg-white shadow-sm">
        <nav class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <div class="text-2xl font-bold">E-Learning</div>
                @if (Route::has('login'))
                <div class="space-x-4">
                    @auth
                    <a href="{{ url('/dashboard') }}" class="font-medium hover:text-blue-600">Dashboard</a>
                    @else
                    <a href="{{ route('login') }}" class="font-medium hover:text-blue-600">Sign In</a>
                    @endauth
                </div>
                @endif
            </div>
    ...
    <main class="pt-20">
        ...
        <section class="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center">
            <div class="lg:w-1/2 lg:pr-16">
                <h1 class="text-4xl lg:text-6xl font-bold mb-6">Learn Smarter,<br />Not Harder</h1>
                <p class="text-gray-600 text-lg mb-8">Transform your learning experience with interactive modules, challenging quizzes, and real-time progress tracking.</p>
                <div class="flex gap-4">
                    <a href="/register" class="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">Start Learning</a>
                    <a href="{{ route('login') }}" class="border border-gray-300 px-8 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors">Sign In</a>
                </div>
            </div>
            <div class="lg:w-1/2 mt-12 lg:mt-0">
                <img src="/images/learning-illustration.png" alt="Learning" class="w-full max-w-xl mx-auto" />
            </div>
        </section>
    </main>
</body>
