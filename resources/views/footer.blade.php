<footer class="bg-white py-8 w-full mt-auto">
    ...
    <div class="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row items-start gap-6 md:gap-8 rounded-xl bg-white shadow-lg">
        ...
        <div class="shrink-0 flex flex-col items-start">
            ...
            <div class="mt-5 flex items-center gap-4">
                ...
                <a href="mailto:admin@abati.com" class="text-gray-400 hover:text-red-500 transition-colors duration-200" title="Email Kami">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                    </svg>
                </a>

                <a href="https://wa.me/6282299385608" target="_blank" class="text-gray-400 hover:text-green-500 transition-colors duration-200" title="Chat WhatsApp">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://instagram.com/abati" target="_blank" class="text-gray-400 hover:text-pink-600 transition-colors duration-200" title="Instagram">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
